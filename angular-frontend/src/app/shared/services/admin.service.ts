...
export class AdminService {
  ...
  private companyUrl = 'http://localhost:8080/coupon-system/admin/company'
  private couponUrl = 'http://localhost:8080/coupon-system/admin/coupon'
  private customerUrl = 'http://localhost:8080/coupon-system/admin/customer'
